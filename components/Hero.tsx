      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8">
        <div>
          ...
          <Reveal delay={240}>
            <div className="mt-9 flex flex-wrap items-center gap-4">
              <a
                href="#download"
                className="group inline-flex items-center gap-2 rounded-full bg-accent px-6 py-3.5 font-display text-[15px] font-semibold text-[#12162A] transition-all hover:bg-accent-strong hover:shadow-[0_0_0_6px_rgba(174,184,245,0.15)]"
              >
          ...
          <Reveal delay={320}>
            <p className="mt-5 font-mono text-xs text-muted">
              v{appConfig.version} · Android {appConfig.minAndroidVersion}+ · Direct install
            </p>
          </Reveal>
        </div>
        ...
        <Reveal delay={200} className="relative mx-auto">
          ...
          <div className="animate-float" style={{ ["--tilt" as string]: "-4deg" }}>
            <PhoneFrame
              src={appConfig.screenshots[0].src}
              alt={appConfig.screenshots[0].alt}
              priority
              className="mx-auto"
            />
          </div>
